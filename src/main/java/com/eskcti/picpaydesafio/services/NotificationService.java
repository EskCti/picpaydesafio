package com.eskcti.picpaydesafio.services;

import com.eskcti.picpaydesafio.domain.user.User;
import com.eskcti.picpaydesafio.dtos.NotificationDTO;
...
//        }
        System.out.println("Notificação: " + notificationRequest.toString());
    }
}
